...
namespace App\Curriculum\A2;

use App\Curriculum\CurriculumLesson;

class Lesson1 extends CurriculumLesson
{
    public static function levelCode(): string { return 'A2'; }

    public static function lessonNumber(): int { return 1; }
