...
import {
  ArrowRight, Loader2, User, Briefcase, Phone, CalendarDays, Undo2, Gem,
} from 'lucide-react';
...
export default function StaffProfilePage() {
  ...
  /* ── Fetch new leads for this staff member ── */
  const {
    data:      leadsData,
    ...
    queryFn:  () => leadsApi.list({
      status:      'new',   // الليدات الجديدة المعيّنة للموظف (لم تُصنَّف بعد)
      assigned_to: staffId,
      per_page:    100,
    }),
    enabled: isAdmin && !!staffId,
