 ...
 * renders Daily's prebuilt call UI directly when embedded in an <iframe> —
 * simpler and more robust than daily-js createFrame (which crashed with
 * "Cannot read properties of null (reading 'postMessage')"). The backend's room
 * URL already carries the owner token (?t=…).
 *
